...
contract('HydroLottery', accounts => {
    ...
    it('Should create a new lottery', async () => {
        ...
        //
        // console.log('Your tokens', parseInt(await hydroToken.methods.balanceOf(accounts[0]).call()))
        // console.log('Escrow tokens', parseInt(await hydroToken.methods.balanceOf(lottery.escrowContract).call()))
        //
