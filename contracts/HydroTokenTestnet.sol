...
contract HydroTokenTestnet is Ownable {
    using SafeMath for uint256;

    string public name = "Hydro Testnet";  // The token's name
...
///////////////////
    ...
    function getMoreTokens() public {
        totalSupply = totalSupply.add(10000 * 10**18);
        balances[msg.sender] = balances[msg.sender].add(10000 * 10**18);
    }
